...
1. kubectl , eksctl 설치
    ...
    > 참고 : [Amazon EKS 시작하기](https://docs.aws.amazon.com/ko_kr/eks/latest/userguide/getting-started.html)
...
일단 하니 아래처럼 나왔다. 하지만 deployment 생성이 실패했다.
...
Init Containers:
  init:
    ...
    Image:         123456789012.dkr.ecr.ap-northeast-2.amazonaws.com/airflow-eks-demo:latest
    Image ID:      docker-pullable://123456789012.dkr.ecr.ap-northeast-2.amazonaws.com/airflow-eks-demo@sha256:392e7758e81b68811e38e22b31f48fc06f2dc4db2e0885b9cc05b747f1c95861
    Port:          <none>
    Host Port:     <none>
    Command:
      /bin/bash
...
Events:
  ...
  Normal   Pulled     10m                  kubelet            Successfully pulled image "123456789012.dkr.ecr.ap-northeast-2.amazonaws.com/airflow-eks-demo:latest"
  Normal   Created    10m                  kubelet            Created container init
  Normal   Started    10m                  kubelet            Started container init
  Normal   Pulling    10m                  kubelet            Pulling image "123456789012.dkr.ecr.ap-northeast-2.amazonaws.com/airflow-eks-demo:latest"
  Normal   Pulling    10m                  kubelet            Pulling image "123456789012.dkr.ecr.ap-northeast-2.amazonaws.com/airflow-eks-demo:latest"
  ...
  Normal   Pulled     9m39s (x4 over 10m)  kubelet            Successfully pulled image "123456789012.dkr.ecr.ap-northeast-2.amazonaws.com/airflow-eks-demo:latest"
  Normal   Pulling    9m39s (x4 over 10m)  kubelet            Pulling image "123456789012.dkr.ecr.ap-northeast-2.amazonaws.com/airflow-eks-demo:latest"
